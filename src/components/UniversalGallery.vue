<template>
    <div class="full-width row wrap justify-center items-center content-center" :class="$windowWidth >= 1080 ? 'CNT__eighty' : 'CNT__all'" id="gallery">
                ...
                <q-card>
                    ...
                    <q-tab-panels v-model="tab" animated class="bg-primary text-white">
                        ...
                        <q-tab-panel name="compare" :height="($windowHeight * 0.75) + 'px'">
                            <image-compare :before="slide2" :after="slide3" :labels="{after: this.$t('gallery.after'), before: this.$t('gallery.before')}"/>
                        </q-tab-panel>
